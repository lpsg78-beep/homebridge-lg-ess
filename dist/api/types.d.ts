...
export declare enum GRAPH_TIMESPAN {
    DAY = "day",
    MONTH = "month",
    YEAR = "month",
    WEEK = "week"
}
export declare const GRAPH_TIMESPAN_DEFAULT = GRAPH_TIMESPAN.MONTH;
export declare enum GRAPH_DEVICE {
    PV = "pv",
    LOAD = "load",
    BATT = "batt"
}
export declare const GRAPH_DEVICE_DEFAULT = GRAPH_DEVICE.PV;
