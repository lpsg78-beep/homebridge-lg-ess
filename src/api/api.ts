...
import {
  ...
  GraphRequestData,
  GraphResponse,
  ISeetingSysteminfoResponseData,
  ISettingBatteryResponseData,
  ISettingCommonResponseData,
  ISettingHomeResponseData,
  ISettingNetworkResponseData,
  LoginResponseData,
} from './types';
export * from './types';
...
export class LgEssApi {
  ...
  async range(device: GRAPH_DEVICE, start: Date, end: Date) {
  ...
  async graph(device: GRAPH_DEVICE, timespan: GRAPH_TIMESPAN, date: Date = new Date()) {
